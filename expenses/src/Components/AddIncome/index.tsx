    ...
    <div className='py-4'>
       ...
       <form onSubmit={onSubmit} className='flex items-center space-x-6'>
           ...
           <input 
              ...
              className="w-1/4 placeholder:text-slate-400 block bg-white border border-slate-300 rounded-md py-2 pl-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" type="text" placeholder="Digite o nome da receita ..." 
           />

           <label className="font-bold" htmlFor="amount">Valor</label>
           <input 
              value={amount} onChange={(e) => setAmount(parseInt(e.target.value))}
              className="w-1/4 placeholder:text-slate-400 block bg-white border border-slate-300 h-9 rounded-md py-2 pl-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" type="number" placeholder="Digite o valor da receita ..."
           />
