    ...
    <div className='pb-4'>
      ...
      <form onSubmit={onSubmit} className='lg:flex md:block  items-center lg:space-x-6'>
        ...
        <input
          ...
          className="lg:w-1/4 w-full placeholder:text-slate-400 block bg-white border border-slate-300 h-9 rounded-md py-2 lg:space-x-0 pl-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" type="number" placeholder="Digite o valor da despesa ..."
        />
